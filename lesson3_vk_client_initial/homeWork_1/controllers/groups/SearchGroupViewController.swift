...
class SearchGroupViewController: UIViewController {
    ...
    private var alamofireServiceProxy: AlamofireServiceProxy = LogServiceProxy()
...
extension SearchGroupViewController {
    ...
    private func getGroups(by search: String) {
        alamofireServiceProxy.searchGroups(search: search, delegate: self)
    }
    
    private func leaveGroup(by gid: Int) {
        alamofireServiceProxy.leaveGroup(gid: gid, delegate: self)
    }
    
    private func joinGroup(by gid: Int) {
        alamofireServiceProxy.joinGroup(gid: gid, delegate: self)
    }
}
